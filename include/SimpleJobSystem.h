...
public:
    ...
    static SimpleJobSystem* create(uint32_t maxThreads, simplejobsystem::IUserTaskRunner* taskRunner);
...
#if ENABLE_SIMPLE_JOB_SYSTEM_IMPLEMENTATION
...
public:
    ...
    void start(FindJobs* fj, simplejobsystem::IUserTaskRunner* taskRunner)
    {
    ...
    simplejobsystem::IUserTaskRunner* mTaskRunner{ nullptr };
};

class SimpleJobSystemImpl : public SimpleJobSystem, public FindJobs
{
public:
    SimpleJobSystemImpl(uint32_t maxThreads, simplejobsystem::IUserTaskRunner* taskRunner)
...
// Create in instance of the SimpleJobSystem with the number of threads specified.
// More threads than available cores is not particularly beneficial.
SimpleJobSystem* SimpleJobSystem::create(uint32_t maxThreads, simplejobsystem::IUserTaskRunner* taskRunner)
{
